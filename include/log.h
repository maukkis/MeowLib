...
namespace Log {
  ...
  constexpr std::string_view warnfmtrstr = "\x1b[0;33mWRN   {:%T} | \x1b[0;37m {}";
  constexpr std::string_view errfmtrstr =  "\x1b[0;31mERR   {:%T} | \x1b[0;37m {}";
  constexpr std::string_view infofmtrstr = "\x1b[38;5;212mINF   {:%T} | \x1b[0;37m {}";
  extern bool enabled;
}
